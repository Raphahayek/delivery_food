class ImageConstant {
  ...
  static String imgCibpaypal = '$imagePath/img_cibpaypal.svg';
  ...
  // iPhone 11 Pro Max - Eighteen images
  static String imgSearch = '$imagePath/img_search.svg';

  // iPhone 11 Pro Max - Twenty images
  static String imgGroupGray40003 = '$imagePath/img_group_gray_400_03.svg';
  ...
  // iPhone 11 Pro Max - Eleven images
  static String imgBellaOlonjeLogo51x104 =
      '$imagePath/img_bella_olonje_logo_51x104.png';

  static String imgMenuGray600 = '$imagePath/img_menu_gray_600.svg';

  static String imgRectangle = '$imagePath/img_rectangle.png';

  static String imgRectangle451x214 = '$imagePath/img_rectangle_451x214.png';

  static String imgRectangle581x414 = '$imagePath/img_rectangle_581x414.png';

  static String imgRectangle1 = '$imagePath/img_rectangle_1.png';

  static String imgRectangle2 = '$imagePath/img_rectangle_2.png';

  static String imgAntDesignTwitterOutlined =
      '$imagePath/img_ant_design_twitter_outlined.svg';

  static String imgAntDesignFacebookFilled =
      '$imagePath/img_ant_design_facebook_filled.svg';

  static String imgAntDesignLinkedinFilled =
      '$imagePath/img_ant_design_linkedin_filled.svg';
  ...
  static String imgBicreditcard2frontfill =
      '$imagePath/img_bicreditcard2frontfill.svg';

  static String imgDashiconsbank = '$imagePath/img_dashiconsbank.svg';
